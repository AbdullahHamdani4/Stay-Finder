        ...
        <div className='px-5 py-4'>
           ...
           <div className="bookingForm bg-white p-4 gap-10  rounded-2xl w-auto max-w-180 hidden lg:flex">
            <div className='flex font-inter text-xs text-[#6B716D] items-center gap-2 font-semibold'>
                <span><i class="text-base fa-solid fa-earth-americas"></i></span>
                ...
                <div className='flex font-inter text-xs text-[#6B716D] items-center gap-2 font-semibold'>
                <span><i class="text-base fa-regular fa-calendar"></i></span>
                <div className='flex flex-col gap-1'>
                ...
                <div className='flex font-inter text-xs text-[#6B716D] items-center gap-2 font-semibold'>
                <span><i class="text-base fa-solid fa-user"></i></span>
                <div className='flex flex-col gap-1'>
                ...
                <div>
                 <button className="bg-[#0D3026] text-white font-inter text-[12px] rounded-[8px] p-2 py-2.5 px-3 hover:cursor-pointer"><i class="text-base fa-solid fa-magnifying-glass mr-2"></i>Search stays</button>
            </div>
           </div>
        </section>
        </div>
