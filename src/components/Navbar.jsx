...
function Navbar() {
    ...
    <div>
        <button className="bg-[#0D3026] text-white font-inter font-semibold text-[12px] rounded-[8px] py-2 px-2.5 md:py-2.5 md:px-3" onClick={(()=>navigate("/ListProperties"))}>List your property</button>
    </div>
  </header>
    )
